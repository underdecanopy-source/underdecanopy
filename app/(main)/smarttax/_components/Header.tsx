...
export const Header = () => {
    ...
    const navLinks = [
        { href: '/', label: 'Home' },
        { href: '/smarttax', label: 'SmartTax' },
        { href: '/smarttax#features', label: 'Features' },
        { href: '/smarttax#compliance', label: 'Compliance' },
        { href: '/smarttax#pricing', label: 'Pricing' },
        { href: '/smarttax#faq', label: 'FAQ' },
        { href: '/smarttax#demo', label: 'Demo' },
    ];
        ...
        <header className="sticky top-0 z-50 w-full bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 shadow-xl border-b-2 border-emerald-400/30">
            <div className="page-container">
                <div className="flex h-16 items-center justify-between">
                    <Link href="/" className="text-xl font-bold text-white transition-all duration-300 hover:scale-105 hover:text-lime-300 flex-shrink-0 drop-shadow-lg">
