            ...
            <header>
                <div className="container">
                    <nav>
                        ...
                        <button className="mobile-menu" aria-label="Toggle navigation menu" aria-expanded={isMenuOpen} onClick={() => setIsMenuOpen(!isMenuOpen)}>
                            <span className="hamburger-icon open">&#9776;</span>
                            <span className="hamburger-icon close" style={{ display: isMenuOpen ? 'block' : 'none' }}>&#10005;</span>
                        </button>
                ...
                <section className="hero" id="home">
                    <div className="container">
                        ...
                        <div className="product-selector">
                            <div className={`product-tab ${activeProduct === 'school-fees' ? 'active' : ''}`} onClick={() => setActiveProduct('school-fees')}>School Fee Management</div>
                            <div className={`product-tab ${activeProduct === 'cooperative' ? 'active' : ''}`} onClick={() => setActiveProduct('cooperative')}>Cooperative Services</div>
                        </div>
