                    ...
                    <div className="container">
                        ...
                        <div className="form-wrap">
                            ...
                            <div id="calculator-panel" role="tabpanel" aria-labelledby="tab-calculator">
                                <form id="admission-calculator-form">
                                    <div className="grid two-col">
                                        ...
                                        <div>
                                            ...
                                            <select name="calc_course" required>
                                ...
                                <div id="calculator-result" className="calculator-result w-0">
                                    <div className="result-header">
                                        <h3>Your Admission Chance</h3>
                            ...
                            <div id="full-form-panel" role="tabpanel" aria-labelledby="tab-full-form hidden">
