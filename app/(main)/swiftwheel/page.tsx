    ...
    return (
        <div>
            ...
            <div className="bg-gray-50 text-gray-800">
                ...
                {/* Hero Section */}
                <section className="bg-blue-900 text-white section-lg text-center">
                ...
                <section id="pricing" className="bg-gray-100 section">
                    <div className="page-container">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                            <div className="border border-gray-300 rounded-lg p-6 shadow bg-white relative">
                                <div className="text-center mb-4">
                                    ...
                                    <p className="text-gray-600">A preferred option for sole proprietors and partnerships seeking a simple business structure</p>
                                </div>
                                <ul className="list-disc list-inside mb-4 space-y-2">
                                    <li>CAC Certificate</li>
                                    <li>Status Report</li>
                                    <li>TIN</li>
                                    <li>Free Business Logo</li>
                                    <li>Free Business Letterhead</li>
                                </ul>
                ...
                <section className="bg-gray-100 py-16 text-center">
                    <div className="page-container">
                        ...
                        <p className="text-gray-600 mb-8 max-w-3xl mx-auto">Click to fill out the necessary forms to begin your CAC registration process</p>
                ...
                <FullContactSection
                    title="Contact Us"
                    subtitle="Reach out to us for professional CAC registration services"
                    serviceOptions={[
                        { value: "Business Name Registration", label: "Business Name Registration" },
                        { value: "Limited Liability Company", label: "Limited Liability Company" },
                        { value: "Conversion to LLC", label: "Conversion to LLC" },
