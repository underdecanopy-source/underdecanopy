...
const navItems = [
    { href: '/', label: 'Home' },
    { href: '/skoolpay/#how-it-works', label: 'How It Works' },
    { href: '/skoolpay/#faq', label: 'FAQ' },
    { href: '/skoolpay/#contact', label: 'Contact' },
                ...
                <nav className="hidden items-center gap-6 md:flex">
                    {navItems.map((item) => (
                        <Link
                            ...
                            className="px-3 !py-1 !text-slate-700 font-bold transition-all tracking-wider hover:!text-[#ff9800] border-b-2 border-b-white hover:border-b-[#ff9800]"
                        >
                            {item.label}
                        </Link>
                    ))}
