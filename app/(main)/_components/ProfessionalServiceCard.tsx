...
export function ProfessionalServiceCard({ icon, title, description }: ProfessionalServiceCardProps) {
  return (
    <div className="group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-blue-600 flex flex-col items-center text-center">
